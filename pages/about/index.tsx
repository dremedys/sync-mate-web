  ...
  return (
    <Root className="container">
      ...
      <Typography variant="h6" color="text.secondary" mb="32px">
        SyncMate is a platform for finding ideal partners for your startup, project or other activities, using advanced
...
AboutPage.getLayout = component => <MainLayout>{component}</MainLayout>;
